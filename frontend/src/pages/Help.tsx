  ...
  const helpItems = [
    {
      ...
      description: 'Click "+ Add Task" on the Board page, fill in the details.',
    },
    {
      title: "Moving tasks:",
      description: "Drag a task card between To Do, In Progress, and Done.",
    },
    {
      title: "Time tracking:",
      description:
        "Tempora automatically tracks how long each task stays In Progress.",
    },
    {
      title: "Analytics:",
      description: "Compare estimated vs. actual time on the Analytics page.",
    },
    {
      title: "Notifications:",
      description: "See tasks that went over their estimated time.",
    },
  ];
  return (
    <div className="p-4 text-text-primary bg-surface-page flex flex-col items-center flex-1 h-screen">
      ...
      <footer className="mt-auto pt-4 border-t border-surface-column w-full flex items-center justify-center gap-3 text-xs text-text-muted/60">
        <span>Made by Ezgi ©</span>
        <a
          title="GitHub"
